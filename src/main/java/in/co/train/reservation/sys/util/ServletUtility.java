...
import in.co.train.reservation.sys.controller.BaseCtl;
import in.co.train.reservation.sys.controller.TRSView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(TRSView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
